...
В этом коде происходит мутирование одного и того же объекта ProfileViewState, что делает непростым управление состоянием из-за потенциальных побочных изменений и синхронизации.
...
Подводя итог, использование иммутабельности значительно упрощает реактивное управление состоянием в Android MVI архитектуре, обеспечивая более чёткий поток данных и минимизируя возможные ошибки.
